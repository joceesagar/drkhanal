...
function page() {
    return (
        <div className='mt-[81px] flex flex-col justify-center items-center lg:gap-[78px] gap-[550px] mb-[81px] px-4'>
            {/* GENERAL INFORMATION */}
            <div className='flex flex-col lg:flex-row gap-[40px] lg:gap-[110px] justify-center w-full'>
                <div className='lg:ml-[57px] flex flex-col gap-[43px]'>
                    ...
                    <div className='flex gap-[20px] flex-col'>
                        <p className='font-inder text-[32px] sm:text-[36px] md:text-[40px] w-full max-w-[357px]'>We&apos;re here for you And your feet.</p>
                        <p className='font-inder text-[14px] max-w-[493px]'>See the full details of clinic hours and contact information below. Use the booking buttons located across this site to book your appointment today.</p>
                    </div>
                    <div className='flex flex-col sm:flex-row gap-[30px] sm:gap-[110px]'>
                        <div className='flex flex-col gap-[18px]'>
                            <p className='text-[#2660e1] font-inder'>Location</p>
                            <p className='w-full max-w-[182px] font-inder'>250 Dundas Street West Suite 305 Mississauga ON L5B 1J2</p>
                        </div>
                        <div className='flex flex-col gap-[18px]'>
                            <p className='text-[#2660e1] font-inder'>Business hours</p>
                            <p className='w-full max-w-[237px] font-inder'>Monday: 9:30 am - 6:30 pm<br />Tuesday: 9:30 am - 6:30 pm<br />Wednesday: 9:30 am - 6:30 pm<br />Thursday: 9:30 am - 6:30 pm<br />Friday: 9:30 am - 6:30 pm<br />Saturday: 9:30 am - 5:00 pm<br />Sunday: Closed</p>
                        </div>
                    </div>
                    <div className='w-full max-w-[261px] mt-[20px] flex flex-col gap-[18px] font-inder'>
                        <p className='text-[#2660e1]'>Contact information</p>
                        <p>Email: mail@drsudhir.com.np<br />Fax: 1-289-276-0511<br />Phone: 905-848-2929</p>
                    </div>
                </div>
                <div className='w-full h-[200px] lg:h-auto lg:w-auto '>
                    <Map />
                </div>
            </div>
            ...
            <div className='flex flex-col lg:flex-row gap-6 w-full justify-center items-center lg:items-start'>
                ...
                <div className='flex flex-col gap-[41px] mt-6 lg:items-start items-center px-2'>
                    <div className='flex flex-col gap-8'>
                        ...
                        <p className='w-full max-w-[670px] font-inder text-[24px] sm:text-[28px] md:text-[32px]'>Your health is not a destination, it&apos;s a journey.</p>
                        <div className='w-full max-w-[523px] font-inder text-[15px] flex flex-col gap-4 '>
